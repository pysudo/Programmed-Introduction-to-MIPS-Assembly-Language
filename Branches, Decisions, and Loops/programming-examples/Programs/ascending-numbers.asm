...
main:
        ori   $6, $0, 0         # Initalize array sorted flag to not sorted in $5.
        ...
        beq   $3, $0, sorted    # If array size is 0, array is already sorted.
        sll   $0, $0, 0         # Branch delay.
        beq   $3, $9, sorted    # If array size is 1, array is already sorted.
        sll   $0, $0, 0         # Branch delay.
...
loop:
        ...
        beq   $10, $0, end      # If destination value is large, swap with source.
        sll   $0, $0, 0         # Branch delay.
...
sorted:
        ori   $6, $0, 1         # The array is sorted in ascending order.
